...
<div id="responsive-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('content-libary.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <label for="body" class="control-label mb-10">Page Link</label>
...
<h4>Manage Home Page Featured Gallery</h4>

<div class="row">
    @foreach($galleryItems as $key => $gal)
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12  file-box">
        <div class="file">
            <div class="icon">
                <img src="{{ asset('uploads/'.$gal['text'] ) }} " alt="">
            </div>
            <div class="file-name">
                <h4>{!! $gal->sub_text !!}</h4>
                <br>
                ...
                <hr>
                <div class="col-md-6"> <a href="{{ route('site-items.edit',['site_item'=>$gal->id]) }}" class="txt-warning "  >Edit</a></div>
                <br>
            </div>
                                ...
                                <div class="ibox-content">
                                    <div class="file-manager">
                                        ...
                                        <div class="mt-20 mb-20 ml-15 mr-15">
                                            ...
                                            <form action="{{ route('content-libary.index') }}" method="get">
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        <input type="text" name="search" placeholder="Page..., Name, Descp" class="form-control">
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id=""
                                                    action="{{ route('gallery.destroy', $cont['id']) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <div class="modal-body">
