...
//PACKAGE EDIT
$('.edit_invest_package').click(function(){

$("#name").val($(this).attr('name'))
$("#min_amt").val($(this).attr('min_amt'))
$("#max_amt").val($(this).attr('max_amt'))
$("#category_name").val($(this).attr('category_name'))

$("#min_percent").val($(this).attr('min_percent'))
$("#max_percent").val($(this).attr('max_percent'))
$("#duration").val($(this).attr('duration'))
$("#compound_duration").val($(this).attr('compound_duration'))
$("#compound_percent").val($(this).attr('compound_percent'))
$("#info_head_1").val($(this).attr('info_head_1'))
$("#info_detail_1").val($(this).attr('info_detail_1'))
$("#info_head_2").val($(this).attr('info_head_2'))
$("#info_detail_2").val($(this).attr('info_detail_2'))
$("#info_head_3").val($(this).attr('info_head_3'))
$("#info_detail_3").val($(this).attr('info_detail_3'))
$("#info_head_4").val($(this).attr('info_head_4'))
$("#info_detail_4").val($(this).attr('info_detail_4'))
$("#info_head_5").val($(this).attr('info_head_5'))
$("#info_detail_5").val($(this).attr('info_detail_5'))
$("#updateInvestPackageForm").attr('action',$(this).attr('action'))
